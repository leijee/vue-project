<template>
	<div class="my-header">
		<div class="header-bar">
			...
			<span class="header-right" v-else-if="type=='back'"><router-link to="/first"><img class="indexImg" src="http://img1.3png.com/32a368b51ec7cb3c6fc395ef1ce8544c41d8.png" alt="" /></router-link></span>
...
<script>
	...
	export default {
		name:'header',
		props:['title','type','isBack','userImg'],
		data(){
			return {
				isLogin:'登陆'
			}
